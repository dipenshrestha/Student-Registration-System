...
<body>
    <div id="container">
                ...
                <ul>
			        ...
			        <li class="drop-menu"><a href="#"><i class="fa fa-bars"></i></a>
                        <ul class="drop-down">
                            ...
                            <li class="active"><a href="adminMessage.php"><i class="fa fa-envelope"></i>  Admin Message</a></li>
        ...
        <div class="container_outer">
            ...
            <div class="container_about_message ">
                <div class="faffl">FAFFL</div>
                <p>
                    Hello! everyone this website is about <b>"Student Registration System"</b>. Hope you like this website. If you have any queries then do  drop message in the feedback form.    
                </p>
                <br/>
            ...
            <footer>
                    ...
                    <div class="quicknav">
                        <ul id="quicknavi">
                            ...
                            <li class="active"><a href="adminMessage.php">  Admin Message</a></li>
